...
| [TASK-034](TASK-034.md) | 🟠 | Correction | Validation rapprochement : caler **date règlement** (`MV_Date`), **date rapprochement** (`DatePointage`) et **date échéance** (`DateEcheance`) sur la **date opération** du relevé (au lieu de la date valeur). `DateOperation` lue **côté serveur** (`RAPP_ReleveBancaire_Ligne` par `ReleveLigneId`). Garde : `MV_Date` **et** `MV_DateEcheance` modifiées **seulement si `MV_Compta=0`** ; `DatePointage` toujours. `ChangeDate` avant `IsPointe` (invariant TASK-031). Hors périmètre : `RapprocherManuel` |
...
## ✅ LIVRÉ (2026-07-07)
TASK-001 · TASK-002 · TASK-003 · TASK-004 · TASK-005 · TASK-006 · TASK-007 · TASK-008-A · TASK-009 · TASK-011 · TASK-012 · TASK-013 · TASK-016 · TASK-017 · TASK-019 · TASK-020 · TASK-021 · TASK-022 · TASK-024 · TASK-025 · TASK-026 · TASK-027 · TASK-028 · TASK-031 · TASK-032 → voir `DONE.md` / `DONE_DETAIL/` / `CHANGELOG.md`.
